...
export const metadata = {
  ...
  description: 'Call or text Cactus Clean Detailing & Clay Bar at (480) 418-5533, or request a booking online. Mobile detailing across Chandler, Gilbert, Mesa and the East Valley.',
}
