...
export const metadata = {
  ...
  description: 'See clay bar, ceramic coating, interior and exterior detailing results from Cactus Clean Detailing around Chandler, Gilbert, Mesa and the East Valley.',
}
