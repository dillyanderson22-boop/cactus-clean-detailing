...
export const metadata = {
  title: 'About — Owner-operated clay bar & detailing in the East Valley',
  description: 'Cactus Clean Detailing & Clay Bar is an owner-operated mobile detailing service in Chandler, AZ. We bring the clay bar and ceramic coating to your driveway.',
}
    ...
    <>
      <Reveal className="mx-auto flex min-h-[72vh] max-w-shell flex-col justify-center px-5 pt-32 lg:px-10">
        ...
        <h1 data-reveal className="mt-5 max-w-5xl font-display text-[clamp(44px,8vw,116px)] font-semibold uppercase leading-[0.9] tracking-tight">
          Detailing done <span className="text-accent">the slow way.</span>
        </h1>
        <p data-reveal className="mt-8 max-w-2xl text-xl leading-relaxed text-fg/85">
          Cactus Clean is an owner-operated mobile detailing service based in Chandler. No franchise, no rushed assembly line — just careful, hand-done work brought straight to you.
        </p>
      </Reveal>
      ...
      <Reveal className="mx-auto grid max-w-shell items-center gap-12 px-5 py-24 lg:grid-cols-2 lg:px-10">
        ...
        <div className="space-y-6 text-lg leading-relaxed text-fg/85">
          ...
          <p data-reveal>From a clay-bar treatment to full ceramic coating, you get the same thing every time: paint that feels like glass and a car that looks like it just rolled off the lot.</p>
