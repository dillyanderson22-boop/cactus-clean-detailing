...
export function Logo() {
  return (
    <Link href="/" className="group flex items-center gap-3" aria-label="Cactus Clean Detailing & Clay Bar — home">
      ...
      <span className="font-display font-semibold uppercase leading-[0.95] tracking-tight text-fg">
        <span className="block text-[13px]">Cactus Clean</span>
        <span className="block text-[13px] text-accent">Detailing &amp; Clay Bar</span>
      </span>
    </Link>
  )
}
